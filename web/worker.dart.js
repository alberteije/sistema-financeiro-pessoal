...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    NestedExecutorControl: function NestedExecutorControl(t0, t1) {
      this.index = t0;
      this._name = t1;
    },
    RunNestedExecutorControl: function RunNestedExecutorControl(t0, t1) {
      this.control = t0;
      this.executorId = t1;
    },
    ...
    runCancellable(operation, $T) {
      ...
      t1.token = token;
      t1.token = null;
      token = new A.CancellationToken(new A._SyncCompleter(new A._Future($.Zone__current, $T._eval$1("_Future<0>")), $T._eval$1("_SyncCompleter<0>")), A._setArrayType([], type$.JSArray_of_void_Function), $T._eval$1("CancellationToken<0>"));
      t1.token = token;
      t2 = type$.nullable_Object;
      A.runZoned(new A.runCancellable_closure(t1, operation, $T), A.LinkedHashMap_LinkedHashMap$_literal([B.Symbol_uzx, token], t2, t2), type$.void);
      return t1.token;
    },
    checkIfCancelled() {
    ...
    _StatementBasedTransactionExecutor: function _StatementBasedTransactionExecutor(t0, t1, t2, t3, t4, t5, t6, t7, t8) {
      var _ = this;
      _._delegate = t0;
      _._opened = null;
      _._engines$_done = t1;
      ...
      _._startCommand = t4;
      _._commitCommand = t5;
      _._rollbackCommand = t6;
      _._db = t7;
      _._lock = t8;
      _._waitingChildExecutors = 0;
    ...
    _ExclusiveExecutor: function _ExclusiveExecutor(t0, t1, t2) {
      var _ = this;
      _._outer = t0;
      _._opened = null;
      _._completer = t1;
    ...
    _ExclusiveExecutor_ensureOpen_closure: function _ExclusiveExecutor_ensureOpen_closure(t0, t1) {
      this.$this = t0;
      this.opened = t1;
    },
    ...
    main() {
      ...
      A._EventStreamSubscription$(t1, "connect", type$.nullable_void_Function_Event._as(new A.main_closure(A.ServerImplementation$(new A.DatabaseConnection(new A.WebDatabase(new A._WebDelegate(new A._IndexedDbStorage("financeiro_pessoal", false, true), null, null, false), false, true, new A.Lock(), new A.Lock())), false, true))), false, type$.Event);
    },
  ...
  A.DriftCommunication.prototype = {
    DriftCommunication$3$debugLog$serialize(_channel, debugLog, serialize) {
      var t1 = this._channel.__GuaranteeChannel__streamController_F;
      t1 === $ && A.throwLateFieldNI("_streamController");
      new A._ControllerStream(t1, A._instanceType(t1)._eval$1("_ControllerStream<1>")).listen$2$onDone(this.get$_handleMessage(), new A.DriftCommunication_closure(this));
    },
    newRequestId$0() {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t1 = $async$self._channel.__GuaranteeChannel__sink_F;
    ...
    _send$1(msg) {
      ...
      t1 = this._channel.__GuaranteeChannel__sink_F;
      t1 === $ && A.throwLateFieldNI("_sink");
  ...
  A.DriftProtocol.prototype = {
    ...
    encodePayload$1(payload) {
      ...
      if (payload instanceof A.NoArgsRequest)
        ...
        return t2;
      } else if (payload instanceof A.RunNestedExecutorControl)
    ...
    decodePayload$1(encoded) {
      var tag, t1, readInt, readNullableInt, method, sql, t2, args, i, list, t3, t4, t5, updates, encodedUpdate, kindIndex, columnCount, columns, rows, result, t6, rowOffset, t7, c, _box_0 = {};
      ...
      switch (tag) {
        ...
        case 4:
          ...
          for (i = 2; i < J.get$length$asx(_box_0.fullMessage) - 1; ++i) {
            ...
            t1 = J.getInterceptor$asx(list);
            t3 = A._asInt(t1.$index(list, 0));
            t4 = [];
            for (t1 = t1.skip$1(list, 1), t5 = t1.$ti, t1 = new A.ListIterator(t1, t1.get$length(0), t5._eval$1("ListIterator<ListIterable.E>")), t5 = t5._eval$1("ListIterable.E"); t1.moveNext$0();) {
              encoded = t1.__internal$_current;
              t4.push(this._decodeDbValue$1(encoded == null ? t5._as(encoded) : encoded));
            }
            B.JSArray_methods.add$1(args, new A.ArgumentsForBatchedStatement(t3, t4));
          }
          return new A.ExecuteBatchedStatement(new A.BatchedStatements(sql, args), A._asIntQ(J.get$last$ax(_box_0.fullMessage)));
        case 5:
          return new A.RunNestedExecutorControl(B.JSArray_methods.$index(B.List_p2F, readInt.call$1(1)), readNullableInt.call$1(2));
        case 6:
  ...
  A.NestedExecutorControl.prototype = {
    _enumToString$0() {
      return "NestedExecutorControl." + this._name;
    }
  };
  A.RunNestedExecutorControl.prototype = {
    toString$0(_) {
  ...
  A.ServerImplementation.prototype = {
    ...
    serve$1(channel) {
      ...
      comm._send$1(new A.Request(comm.newRequestId$0(), new A.ServerInfo(B.SqlDialect_0_sqlite)));
    ...
    _spawnExclusive$2(comm, executor) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.int),
        $async$returnValue, $async$self = this, exclusive, id;
      var $async$_spawnExclusive$2 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$goto = 3;
              return A._asyncAwait($async$self._loadExecutor$1(executor), $async$_spawnExclusive$2);
            case 3:
              // returning from await.
              exclusive = $async$result.beginExclusive$0();
              id = $async$self._putExecutor$2$beforeCurrent(exclusive, true);
              $async$goto = 4;
              return A._asyncAwait(exclusive.ensureOpen$1(new A._ServerDbUser($async$self, comm, $async$self._knownSchemaVersion)), $async$_spawnExclusive$2);
            case 4:
              // returning from await.
              $async$returnValue = id;
              // goto return
      ...
      return A._asyncStartSync($async$_spawnExclusive$2, $async$completer);
    },
      ...
      var $async$_transactionControl$3 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$goto = action === B.NestedExecutorControl_0 ? 3 : 5;
              break;
            case 3:
              // then
              $async$goto = 6;
            ...
            case 5:
              // else
              $async$goto = action === B.NestedExecutorControl_3 ? 7 : 8;
              break;
            case 7:
              // then
              $async$goto = 9;
              return A._asyncAwait($async$self._spawnExclusive$2(comm, executorId), $async$_transactionControl$3);
            case 9:
              // returning from await.
              $async$returnValue = $async$result;
              // goto return
            ...
            case 4:
              // join
              $async$goto = 10;
              return A._asyncAwait($async$self._loadExecutor$1(executorId), $async$_transactionControl$3);
            case 10:
              // returning from await.
              executor = $async$result;
              $async$goto = action === B.NestedExecutorControl_4 ? 11 : 12;
              break;
            case 11:
              // then
              $async$goto = 13;
              return A._asyncAwait(J.close$0$x(executor), $async$_transactionControl$3);
            case 13:
              // returning from await.
              executorId.toString;
  ...
  A.DatabaseConnection.prototype = {
    beginExclusive$0() {
      return new A._ExclusiveExecutor(this.executor, new A._AsyncCompleter(new A._Future($.Zone__current, type$._Future_void), type$._AsyncCompleter_void), new A.Lock());
    },
    beginTransaction$0() {
      var t1 = this.executor;
      return t1.beginTransactionInContext$1(t1);
    },
    close$0(_) {
      return this.executor.close$0(0);
    },
    ensureOpen$1(user) {
      return this.executor.ensureOpen$1(user);
    },
    runBatched$1(statements) {
      return this.executor.runBatched$1(statements);
    },
    runCustom$2(statement, args) {
      return this.executor.runCustom$2(statement, args);
    },
    runDelete$2(statement, args) {
      return this.executor.runDelete$2(statement, args);
    },
    runInsert$2(statement, args) {
      return this.executor.runInsert$2(statement, args);
    },
    runSelect$2(statement, args) {
      return this.executor.runSelect$2(statement, args);
    },
    $isQueryExecutor: 1
  };
  ...
  A.runCancellable_closure.prototype = {
    call$0() {
      return this._box_0.token._resultCompleter.complete$1(0, A.Future_Future$sync(this.operation, this.T));
    },
    $signature: 0
  };
  ...
  A._BaseExecutor.prototype = {
    ...
    _synchronized$1$1(action, $T) {
      ...
      if (this.get$isSequential() || this._waitingChildExecutors > 0)
    ...
    beginExclusive$0() {
      return new A._ExclusiveExecutor(this, new A._AsyncCompleter(new A._Future($.Zone__current, type$._Future_void), type$._AsyncCompleter_void), new A.Lock());
    },
    beginTransaction$0() {
      return this.beginTransactionInContext$1(this);
    }
  };
  ...
  A._StatementBasedTransactionExecutor.prototype = {
    ...
    beginTransactionInContext$1(context) {
      var t1 = this.depth + 1;
      return new A._StatementBasedTransactionExecutor(this._delegate, new A._AsyncCompleter(new A._Future($.Zone__current, type$._Future_void), type$._AsyncCompleter_void), context, t1, A._defaultSavepoint(t1), A.delegates___defaultRelease$closure().call$1(t1), A._defaultRollbackToSavepoint(t1), this._db, new A.Lock());
    },
    send$0(_) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
  ...
  A.DelegatedDatabase_close_closure.prototype = {
    call$0() {
      var t1 = this.$this;
      if (t1._ensureOpenCalled && !t1._closed) {
        t1._closed = true;
  ...
  A._BeforeOpeningExecutor.prototype = {
    beginTransactionInContext$1(context) {
      return this._base.beginTransactionInContext$1(context);
    },
    ensureOpen$1(_) {
      this._ensureOpenCalled = true;
  ...
  A._ExclusiveExecutor.prototype = {
    ensureOpen$1(user) {
      var t1, opened, t2, _this = this,
        _0_0 = _this._opened;
      if (_0_0 != null)
        return _0_0.future;
      else {
        _this._ensureOpenCalled = true;
        t1 = new A._Future($.Zone__current, type$._Future_bool);
        opened = new A._AsyncCompleter(t1, type$._AsyncCompleter_bool);
        _this.set$_opened(opened);
        t2 = _this._outer;
        ++t2._waitingChildExecutors;
        t2._synchronized$1$1(new A._ExclusiveExecutor_ensureOpen_closure(_this, opened), type$.Null);
        return t1;
      }
    },
    get$impl() {
      return this._outer.get$impl();
    },
    beginTransactionInContext$1(context) {
      return this._outer.beginTransactionInContext$1(context);
    },
    close$0(_) {
  ...
  A._ExclusiveExecutor_ensureOpen_closure.prototype = {
    call$0() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.Null),
        $async$self = this, t1;
      var $async$call$0 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$self.opened.complete$1(0, true);
              t1 = $async$self.$this;
              $async$goto = 2;
              return A._asyncAwait(t1._completer.future, $async$call$0);
            case 2:
              // returning from await.
              --t1._outer._waitingChildExecutors;
              // implicit return
              return A._asyncReturn(null, $async$completer);
          }
      });
  ...
  (function installTearOffs() {
    ...
    _static(A, "async___rootHandleUncaughtError$closure", 5, null, ["call$5"], ["_rootHandleUncaughtError"], 67, 0);
    ...
    _static(A, "async___rootErrorCallback$closure", 5, null, ["call$5"], ["_rootErrorCallback"], 74, 0);
    _static(A, "async___rootScheduleMicrotask$closure", 4, null, ["call$4"], ["_rootScheduleMicrotask"], 75, 0);
    _static(A, "async___rootCreateTimer$closure", 5, null, ["call$5"], ["_rootCreateTimer"], 76, 0);
    _static(A, "async___rootCreatePeriodicTimer$closure", 5, null, ["call$5"], ["_rootCreatePeriodicTimer"], 77, 0);
    _static(A, "async___rootPrint$closure", 4, null, ["call$4"], ["_rootPrint"], 78, 0);
    _static_1(A, "async___printToZone$closure", "_printToZone", 79);
    _static(A, "async___rootFork$closure", 5, null, ["call$5"], ["_rootFork"], 80, 0);
    _instance(A._Completer.prototype, "get$completeError", 0, 1, null, ["call$2", "call$1"], ["completeError$2", "completeError$1"], 18, 0, 0);
    _instance(A._AsyncCompleter.prototype, "get$complete", 1, 0, function() {
      return [null];
    }, ["call$1", "call$0"], ["complete$1", "complete$0"], 50, 0, 0);
    ...
    _instance(_, "get$addError", 0, 1, function() {
      return [null];
    }, ["call$2", "call$1"], ["addError$2", "addError$1"], 18, 0, 0);
    ...
    _instance(A.MessagePort.prototype, "get$postMessage", 1, 1, function() {
      return [null];
    }, ["call$2", "call$1"], ["postMessage$2", "postMessage$1"], 85, 0, 0);
    _static_1(A, "js___convertToDart$closure", "_convertToDart", 81);
    _instance_1_u(A.DriftCommunication.prototype, "get$_handleMessage", "_handleMessage$1", 20);
    ...
    _static_1(A, "sql_js_SqlJsModule_____tearOff$closure", "SqlJsModule_____tearOff", 83);
  ...
  (function inheritance() {
    ...
    _inheritMany(A._Enum, [A.NoArgsRequest, A.StatementMethod, A.NestedExecutorControl, A.UpdateKind, A.SqlDialect]);
    ...
    _inheritMany(A._BaseExecutor, [A._TransactionExecutor, A.DelegatedDatabase, A._BeforeOpeningExecutor, A._ExclusiveExecutor]);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "~(String,@)", "bool(String)", "~(@)", "Frame()", "~(Event)", "Frame(String)", "@(@)", "Null()", "~(Object,StackTrace)", "~(@,@)", "Future<Null>()", "Null(Event)", "Future<~>()", "~(~())", "String(int)", "Trace(String)", "Null(@)", "~(Object[StackTrace?])", "bool()", "~(Object?)", "@()", "int(int,int)", "int(int)", "String(String)", "~(Uint8List,String,int)", "~(String,String)", "bool(~)", "Future<int>()", "int(Frame)", "String(Frame)", "Uint8List(@,@)", "Null(bool)", "Null(@,StackTrace)", "Null(@,@)", "@(@,@)", "~(int,@)", "JsFunction(@)", "JsArray<@>(@)", "JsObject(@)", "Future<~>(Request)", "Object?(Object?)", "int?(int)", "Null(~)", "@(Request)", "~(Object?,Object?)", "Future<@>()", "CancellationToken<@>?()", "Future<QueryResult>()", "@(String)", "~([Object?])", "int()", "Future<bool>()", "Map<String,@>(List<Object?>)", "~(MessageEvent)", "~(VersionChangeEvent)", "@(@,String)", "0^(0^,0^)<num>", "List<Frame>(Trace)", "int(Trace)", "~(Symbol0,@)", "String(Trace)", "~(String,int)", "~(String,int?)", "Frame(String,String)", "Trace()", "Null(Object,StackTrace)", "~(Zone?,ZoneDelegate?,Zone,Object,StackTrace)", "0^(Zone?,ZoneDelegate?,Zone,0^())<Object?>", "0^(Zone?,ZoneDelegate?,Zone,0^(1^),1^)<Object?,Object?>", "0^(Zone?,ZoneDelegate?,Zone,0^(1^,2^),1^,2^)<Object?,Object?,Object?>", "0^()(Zone,ZoneDelegate,Zone,0^())<Object?>", "0^(1^)(Zone,ZoneDelegate,Zone,0^(1^))<Object?,Object?>", "0^(1^,2^)(Zone,ZoneDelegate,Zone,0^(1^,2^))<Object?,Object?,Object?>", "AsyncError?(Zone,ZoneDelegate,Zone,Object,StackTrace?)", "~(Zone?,ZoneDelegate?,Zone,~())", "Timer(Zone,ZoneDelegate,Zone,Duration,~())", "Timer(Zone,ZoneDelegate,Zone,Duration,~(Timer))", "~(Zone,ZoneDelegate,Zone,String)", "~(String)", "Zone(Zone?,ZoneDelegate?,Zone,ZoneSpecification?,Map<Object?,Object?>?)", "Object?(@)", "_Future<@>(@)", "SqlJsModule(_SqlJs)", "Null(~())", "~(@[List<Object>?])", "String(String?)"],
...
;
    ...
    B.NestedExecutorControl_0 = new A.NestedExecutorControl(0, "beginTransaction");
    B.NestedExecutorControl_1 = new A.NestedExecutorControl(1, "commit");
    B.NestedExecutorControl_2 = new A.NestedExecutorControl(2, "rollback");
    B.NestedExecutorControl_3 = new A.NestedExecutorControl(3, "startExclusive");
    B.NestedExecutorControl_4 = new A.NestedExecutorControl(4, "endExclusive");
    B.List_p2F = A._setArrayType(makeConstList([B.NestedExecutorControl_0, B.NestedExecutorControl_1, B.NestedExecutorControl_2, B.NestedExecutorControl_3, B.NestedExecutorControl_4]), A.findType("JSArray<NestedExecutorControl>"));
